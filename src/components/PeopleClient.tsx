...
function ProfileCard({ person, large = false }: { person: PersonData; large?: boolean }) {
  ...
  return (
    ...
    >
      <div className={`flex flex-col items-center text-center gap-6 relative z-10 flex-grow`}>
        <div 
...
export default function PeopleClient({ 
  leadershipData, 
  advisorData, 
  scholarlyNetworkData, 
  technicalTeamData 
}: { 
  leadershipData: PersonData[]; 
  advisorData: PersonData; 
  scholarlyNetworkData: PersonData[]; 
  technicalTeamData: PersonData[]; 
}) {
  return (
