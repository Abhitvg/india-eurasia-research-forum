...
export default function Header() {
  ...
  const [lang, setLang] = useState<'EN' | 'HI' | 'RU'>('EN');
      ...
      >
        ...
        <div className="flex shrink-0 items-center">
          <Link href="/" className="flex items-center gap-2 md:gap-3 group">
            ...
            <span
              className={`hidden sm:block font-bold tracking-wide transition-all duration-300 whitespace-nowrap ${
                isLight ? 'text-white' : 'text-[#1B3B5F]'
              } ${
                scrolled ? 'text-[13px] md:text-[16px]' : 'text-[14px] md:text-[18px]'
              }`}
