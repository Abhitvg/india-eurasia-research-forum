  ...
  return (
    <div className="flex flex-col min-h-screen">
            ...
            <ScrollReveal delay={0.2}>
              <div className="p-8 md:p-10 flex flex-col h-full bg-white group relative overflow-hidden transition-all hover:bg-[#E87722] rounded-3xl md:rounded-[4rem] border border-gray-100 hover:border-[#E87722] shadow-xl hover:shadow-[#E87722]/30">
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <p className="text-gray-500 group-hover:text-white/80 text-lg leading-relaxed mb-12 font-medium italic border-l-[3px] border-[#E87722] group-hover:border-white/30 pl-8 py-2">
      ...
      <section id="volga-to-ganga" className="py-20 md:py-32 bg-[#1B3B5F] relative overflow-hidden">
        <div className="absolute inset-0 opacity-[0.04] pointer-events-none" style={{ backgroundImage: `url("data:image/svg+xml,%3Csvg width='6' height='6' viewBox='0 0 6 6' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%23ffffff' fill-opacity='0.3' fill-rule='evenodd'%3E%3Cpath d='M5 0h1L0 5V4zM6 5v1H5z'/%3E%3C/g%3E%3C/svg%3E")` }}></div>
